                ...
                {criticalProducts.map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <img src={p.images[0]} className="w-12 h-12 rounded-lg object-cover shadow-sm border border-slate-100 dark:border-slate-800" alt="" />
                      <div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {products.slice(0, 3).map((p, idx) => (
                <div key={p.id} className="flex justify-between items-center p-2.5 hover:bg-slate-50 dark:hover:bg-slate-850 rounded-xl transition-all">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <img src={p.images[0]} className="w-12 h-12 rounded-lg object-cover border border-slate-100 dark:border-slate-800 shadow-sm" alt="" />
