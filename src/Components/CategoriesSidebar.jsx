...
const CategoriesSidebar = ({ open, setOpen, activeMenu }) => {
    ...
    const categories = menuData[activeMenu] || [];
              ...
              "
                      ...
                      "
                                            onClick={() => {
                                                ...
                                                if (activeMenu === "MEN") {
                                                    navigate(`/men?category=${encodeURIComponent(item.name)}`);
                                                } else if (activeMenu === "WOMEN") {
                                                    navigate(`/women?category=${encodeURIComponent(item.name)}`);
                                                } else if (activeMenu === "KIDS") {
                                                    navigate(`/kids?category=${encodeURIComponent(item.name)}`);
                                                } else if (activeMenu === "NEW") {
                                                    navigate(`/new-arrivals?category=${encodeURIComponent(item.name)}`);
                                                }
                                            }}
                                        >
